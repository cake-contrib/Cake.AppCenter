...
{
	/// <summary>
	/// Settings for appcenter codepush release-cordova.
	/// Release a Cordova update to an app deployment.
	/// </summary>
	[CompilerGenerated]
	public sealed class AppCenterCodepushReleaseCordovaSettings : AutoToolSettings
	{
		/// <summary>
		...
		/// </summary>
		public bool? IsReleaseBuildType { get; set; }
		/// <summary>
		/// -b|--build
		/// Invoke &quot;cordova build&quot; instead of &quot;cordova prepare&quot;
		/// </summary>
