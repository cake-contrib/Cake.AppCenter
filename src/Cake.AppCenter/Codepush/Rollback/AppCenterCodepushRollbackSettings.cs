...
{
	/// <summary>
	/// Settings for appcenter codepush rollback.
	/// Rollback a deployment to a previous release.
	/// </summary>
	[CompilerGenerated]
	public sealed class AppCenterCodepushRollbackSettings : AutoToolSettings
	{
		/// <summary>
		/// --target-release &lt;arg&gt;
		/// Specifies the release label to be rolled back
		/// </summary>
